...
class VaultQueryTests : TestDependencyInjectionBase() {
    ...
    fun setUp() {
        ...
        notaryServices = MockServices(DUMMY_NOTARY_KEY, DUMMY_CASH_ISSUER_KEY)
    }
    ...
    fun `unconsumed fungible assets by owner`() {
        database.transaction {
            ...
            services.fillWithSomeTestCash(100.DOLLARS, notaryServices, DUMMY_NOTARY, 2, 2, Random(0L), issuedBy = (DUMMY_CASH_ISSUER))
            services.fillWithSomeTestCash(100.DOLLARS, notaryServices, DUMMY_NOTARY, 1, 1, Random(0L),
